<template>
  <div>
    ...
    <common-search :options="nationalitySearch" @search="requestList" :loading="loading"></common-search>
    <div>
...
import { nationalitys, delNationality } from '@/assets/api/nationality'
import { nationalitySearch } from '@/assets/js/searchOption'
export default {
  data () {
    return {
      nationalitySearch,
  ...
  methods: {
    ...
    requestList (searchForm) {
      ...
      nationalitys(Object.assign(sendData, search)).then(res => {
        let data = res.data
